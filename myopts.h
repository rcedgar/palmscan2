...
STR_OPT(OTHER, alnqc)
STR_OPT(OTHER, msaqc)
STR_OPT(OTHER, msaqc2)
STR_OPT(OTHER, msaqc3)
STR_OPT(OTHER, logpssms)
STR_OPT(OTHER, agreefastaout)
STR_OPT(OTHER, qhitfastaout)
STR_OPT(OTHER, rex)
STR_OPT(OTHER, align_msas)
STR_OPT(OTHER, search_pssms)
STR_OPT(OTHER, cluster_cl)
...
STR_OPT(OTHER, triout)
STR_OPT(OTHER, calout)
STR_OPT(OTHER, caloutx)
STR_OPT(OTHER, pdboutx)
STR_OPT(OTHER, chain)
STR_OPT(OTHER, db)
...
FLT_OPT(OTHER,	threshold,		1.0,		0.0,		9e9)
...
FLT_OPT(OTHER,	mincscore,			0.0,		0.0,		DBL_MAX)
...
FLAG_OPT(OTHER, permuted)
FLAG_OPT(OTHER, notpermuted)
FLAG_OPT(OTHER, trace)
